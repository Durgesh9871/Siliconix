...
function Homepage(){
    return(<Box width={"100%"} marginTop="4rem"><Box backgroundColor={"#e0e6ef"} paddingBottom="60px" w={{base:"600px",sm:"700px",md:"1000px",lg:"100%",xl:"100%","2xl":"100%"}}>
        
        <Box width={"100%"} >
            <Image src="https://github.com/Durgesh9871/nappy-view-6299/blob/fp04_437_day5/src/Pages/R_Sai_Kiran_Folder/Images/Screenshot_20221217_031712.png?raw=true" w={{base:"100%", sm:"100%",md:"100%",lg:"100%",xl:"100%","2xl":"100%"}}></Image>
        </Box>
    ...
    <Box >
        ...
        {data.map((item)=>(<Box key={item.id} ><Link color={"#f9dc04"}><Box overflow='hidden' backgroundColor="white" borderRadius={"50%"} padding={"20px"}  border={"3px solid #4c7ee9"}><Image  src={item.image}/></Box><Text marginTop="10px" textAlign={"center"}  color={"blue"} fontSize='sm'>{item.title}</Text></Link></Box>))}
    </Container></Box>
    </Box>


    <Box id="Box2" marginTop="40px"  w={{base:"100%", sm:"100%",md:"100%",lg:"100%",xl:"100%","2xl":"100%"}}>
    ...
    <Box display={"flex"}  marginTop={"20px"} justifyContent={"space-between"} gap="10px" padding="20px" w={{base:"600px",sm:"700px",md:"1000px",lg:"100%",xl:"100%","2xl":"100%"}}>
    ...
    <Box marginTop={"20px"} w={{base:"600px",sm:"700px",md:"1000px",lg:"100%",xl:"100%","2xl":"100%"}}>
    ...
    <Box display={"grid"} gridTemplateColumns="repeat(3, 1fr)" gap={"20px"}  marginLeft="10px" marginRight={"10px"} marginTop="40px" w={{base:"600px",sm:"700px",md:"1000px",lg:"100%",xl:"100%","2xl":"100%"}}>
    ...
    <Box marginTop={"40px"} marginLeft="10px" marginRight={"10px"} w={{base:"600px",sm:"700px",md:"1000px",lg:"100%",xl:"100%","2xl":"100%"}}>
        ...
        <Box display={"grid"} gridTemplateColumns="repeat(3, 1fr)" gap={"40px"} marginTop="15px">
            {Ourfeaturedoffers.map((item)=>(<Box key={item.id} padding={"10px"} borderRight="1px solid #dbdee5"><Box paddingLeft={"40px"} paddingRight="40px" ><Image src={item.image}/></Box><Heading marginTop={"10px"}><Link color={"blue"}>{item.title}</Link></Heading><Text>{item.details}</Text></Box>))}
        </Box>
    </Box>
    ...
    <Box  marginTop="40px" border={"1px solid #dfe2e7"}  w={{base:"100%", sm:"100%",md:"100%",lg:"100%",xl:"100%","2xl":"100%"}}>
        <Box fontSize={"20px"} marginLeft="20px"><b>Featured Products for you</b></Box>
    <Box id="Box2">{Newarrivals.map((item)=>(<Box key={item.id} padding="30px"><Link color='teal.500'><Box backgroundColor="white" ><Image height={"120px"} margin="auto" src={item.image}/></Box><Text marginTop="20px" fontSize={"20px"} color={"blue"} >{item.title}</Text></Link></Box>))}</Box>
    </Box>
