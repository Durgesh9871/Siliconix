import { Flex, Spacer, Input , Box, Heading, useDisclosure, Button, Center, Switch, useColorMode,Link,AccordionButton,AccordionItem, Accordion,AccordionPanel,InputGroup, InputRightElement, ButtonGroup, Grid, GridItem,Image, Divider} from '@chakra-ui/react'
...
function Navbar1(){
    ...
    return(
      <Box  bg="#0046be">
        <Grid templateColumns='68px 86px 10fr 7fr 75px' gap={6} padding="1rem 3rem"> 
