...
const ProductLaptop = ({ item }) => {
	...
	return (
		<Box padding="10px" textAlign="left">
			...
			<Text fontSize="15px" color="#26a541" fontWeight="500" mt="12px">
				Special price
			</Text>
			...
			<Box mt="4px" style={{ display: 'flex', alignItems: 'center' }}>
				...
				<Box color="#8f8a8f">
					<Text fontWeight="600" fontSize="17px" ml="6px">
						{item.rating} ratings and 2 reviews
					</Text>
				</Box>
			</Box>
			...
			<Box mt="30px">
				<Text fontSize="20px" fontWeight="700" color="#303030">
					<u> Top Reviews From Our Customers</u>
				</Text>
				{/* addind review --------------------------------- */}
				<Box display="flex" alignItems="center">
					...
					>
						{' '}
						<Text color="#fffcfa" fontSize="17px">
							Share
						</Text>
					</Button>
				</Box>
					...
					return (
						<Box mt={5} key={i}>
							<Box display="flex">
								...
								<Text fontSize="12px" fontWeight="600" color="#8f8a8f" ml={2}>
									Verified User
								</Text>
							</Box>
							<Text fontSize="15px" fontWeight="500" color="#303030" ml="3">
								{item}
							</Text>
						</Box>
					);
